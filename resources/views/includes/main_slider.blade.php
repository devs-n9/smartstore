        ...
        <div id="rev_slider" class="rev_slider"  data-version="5.0">
            <ul style="position: relative;">
                ...
                <li data-transition="fade">
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('assets/images/bg/bg-1.jpg') }}"  alt=""  width="1920" height="600">
                ...
                <li data-transition="fade">
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('assets/images/bg/bg-2.jpg') }}"  alt=""  width="1920" height="600">
                ...
                <li data-transition="fade">
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('assets/images/bg/bg-3.jpg') }}"  alt=""  width="1920" height="600">
